...
def Mapper(jsmr_context, dataline): 
  ...
  if is_straight and is_flush: 
    jsmr_context.emit_intermediate('straightflush', '1') 
  elif is_quad: 
    jsmr_context.emit_intermediate('4ofakind', '1') 
  elif is_trip and is_pair: 
    jsmr_context.emit_intermediate('fullhouse', '1') 
  elif is_flush: 
    jsmr_context.emit_intermediate('flush', '1') 
  elif is_straight: 
    jsmr_context.emit_intermediate('straight', '1') 
  elif is_4straight:
    jsmr_context.emit_intermediate('4straight', '1') 
  elif is_trip: 
    jsmr_context.emit_intermediate('3ofakind', '1') 
  elif is_two_pair: 
    jsmr_context.emit_intermediate('2pair', '1') 
  elif is_pair: 
    jsmr_context.emit_intermediate('pair', '1') 
  else: 
    jsmr_context.emit_intermediate('highcard', '1') 
